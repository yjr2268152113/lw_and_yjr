      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle-l" ref="middleL">
          <div class="cd-wrapper" ref="cdWrapper">
            <div class="cd">
            <img src="(currentSong.al && currentSong.al.picUrl) || (currentSong.artists && currentSong.artists[0].img1v1Url)" alt="" ref="image" :class="cdCls"
            class="image"
            >
            </div>
          </div>
          <div class="playing-lyric0-wrapper">
